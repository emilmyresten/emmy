...
let suite =
  [
    (let integers = "(def x 1)"
     ...
     and expected_context = "x = Integer 1\n" in
     ( integers,
       `Quick,
    ...
    (let addition = "(def inc (fn x -> (+ x 1))); \n      (inc 1)"
     ...
     and expected_context =
       "inc = (Function x -> (+ Identifier x Integer 1))\n"
     in
     ( addition,
       `Quick,
    ...
    (let subtraction = "(def dec (fn x -> (- x 1))); \n      (dec 1)"
     ...
     and expected_context =
       "dec = (Function x -> (- Identifier x Integer 1))\n"
     in
     ( subtraction,
       `Quick,
    ...
    (let multiplication =
     ...
     and expected_context =
       "multiply = (Function x -> (* Identifier x Integer 2))\n"
     in
     ( multiplication,
       `Quick,
    ...
    (let division = "(def divide (fn x -> (/ x 2))); \n      (divide 2)"
     and expected_result = "Integer 1"
     and expected_context =
       "divide = (Function x -> (/ Identifier x Integer 2))\n"
     in
     ( division,
       `Quick,
